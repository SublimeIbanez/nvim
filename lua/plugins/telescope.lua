return {
  -- Telescope
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>fg", builtin.live_grep, { noremap = true, silent = true, desc = "Find Grep" })
      ...
      vim.keymap.set("n", "<leader>co", builtin.diagnostics, { noremap = true, silent = true, desc = "Diagnostics List" })
    end,
  },

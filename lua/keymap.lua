...
-- MacOS cmd-h and cmd-k don't work and I don't think they're making it to alacritty
...
-- Help
vim.keymap.set({ "n", "v" }, "<leader>?s", "<cmd>:h nvim-surround.usage<cr>", { noremap = true, silent = true, desc = "Surround" })
vim.keymap.set({ "n", "v" }, "<leader>?n", "<cmd>:h neo-tree<cr>", { noremap = true, silent = true, desc = "Neotree" })
vim.keymap.set({ "n", "v" }, "<leader>?t", "<cmd>:h telescope.nvim<cr>", { noremap = true, silent = true, desc = "Telescope" })
vim.keymap.set({ "n", "v" }, "<leader>?m", "<cmd>:h multiple-cursors.nvim-overview<cr>", { noremap = true, silent = true, desc = "MultipleCursors" })
vim.keymap.set({ "n", "v" }, "<leader>?b", "<cmd>:h bufferline<cr>", { noremap = true, silent = true, desc = "Bufferline" })
vim.keymap.set({ "n", "v" }, "<leader>?d", "<cmd>:h dap.txt<cr>", { noremap = true, silent = true, desc = "Debug" })
vim.keymap.set({ "n", "v" }, "<leader>?g", "<cmd>:h fugitive<cr>", { noremap = true, silent = true, desc = "Git" })
vim.keymap.set({ "n", "v" }, "<leader>?T", "<cmd>:h toggleterm.txt<cr>", { noremap = true, silent = true, desc = "Terminal" })
vim.keymap.set({ "n", "v" }, "<leader>?k", "<cmd>:h map<cr>", { noremap = true, silent = true, desc = "Keybinds" })
vim.keymap.set({ "n", "v" }, "<leader>?w", "<cmd>:h which-key.nvim.txt<cr>", { noremap = true, silent = true, desc = "Which-Key" })
vim.keymap.set({ "n", "v" }, "<leader>?D", "<cmd>:h dashboard.txt<cr>", { noremap = true, silent = true, desc = "Dashboard" })
